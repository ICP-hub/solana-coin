import {
  bignumber_default
} from "./chunk-GWLFM7ML.js";
import {
  require_crypto_browserify
} from "./chunk-TFASP4MN.js";
import "./chunk-3SDOM6TE.js";
import "./chunk-5S3VPKBW.js";
import {
  Keypair,
  PublicKey,
  SYSVAR_RENT_PUBKEY,
...
// node_modules/@solana/codecs/dist/index.browser.js
init_process();
init_buffer();
...
// node_modules/@solana/options/dist/index.browser.js
init_process();
init_buffer();
...
function createInitializeInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:initialize_account"), getStructEncoder([
...
function createUpdateFieldInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:updating_field"), getStructEncoder([
...
function createRemoveKeyInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:remove_key_ix"), getStructEncoder([
...
function createUpdateAuthorityInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:update_the_authority"), getStructEncoder([["newAuthority", getPublicKeyEncoder2()]])).encode({ newAuthority: newAuthority ?? SystemProgram.programId }))
  });
}
function createEmitInstruction(args) {
  ...
  return new TransactionInstruction({
    ...
    data: Buffer.from(getInstructionEncoder2(splDiscriminate("spl_token_metadata_interface:emitter"), getStructEncoder([
